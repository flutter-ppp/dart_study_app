...
start() async {
  ...
  receivePort.sendPort.send("China");
  //监听管道消息
...
getMsg(sendPort) => sendPort.send("Hello world");
...
void main() async {
  ...
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample2......."));
  sample2();
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample3......."));
  print(await fetchContent()); //等待Hello 2019的返回
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample4......."));
  sample4();
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample5......."));
  print("func before");
  func();
  print("func after");
  await Future.delayed(
      const Duration(seconds: 2), () => print(".......sample6......."));
  Isolate.spawn(doSth, "Hi");
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample7......."));
  start();
  await Future.delayed(
      const Duration(seconds: 1), () => print(".......sample8......."));
